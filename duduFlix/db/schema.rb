...
ActiveRecord::Schema.define(version: 2018_07_19_011659) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["​favoritable_type", "​favoritable_id"], name: "index_favorites_on_​favoritable_type_and_​favoritable_id"
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["​user_id"], name: "index_reviews_on_​user_id"
  end
